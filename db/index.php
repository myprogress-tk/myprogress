...
<html lang="en">
    <head>
        ...
        <meta name="author" content="it5_j05h">
        ...
        <link rel="icon" type="image/png" sizes="16x16" href="./img/favicon/apple-touch-icon.png">
    ...
    <body id="page-top">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <span class="d-block d-lg-none">My Progress</span>
                <span class="d-none d-lg-block">
                    <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="/img/favicon/apple-touch-icon.png" alt="" width="200px" style="background-color: white; border:none;">
                </span>
            </a>
